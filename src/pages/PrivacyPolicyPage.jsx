      ...
      <div className="max-w-3xl mx-auto w-full px-6 py-16">
        ...
        <div className="space-y-10 text-[#999] text-sm leading-relaxed">
          ...
          <section>
            ...
            <p className="mb-3">When you apply for work through Vanda, we collect the information you provide in the application form, including your name, phone number, email address, location, availability, and any other details you submit.</p>
          ...
          <section>
            ...
            <p className="mb-3">If you apply to work with Vanda, you may receive SMS messages regarding your application status, available shifts, shift details, and briefing reminders. Message frequency varies based on shift activity.</p>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 ml-2">
              ...
              <li><strong className="text-white">Legal compliance:</strong> We may disclose information if required by law or to protect the rights, property, or safety of Vanda, our workers, or the public</li>
            </ul>
          </section>
