...
const SEO_PAGES = {
  ...
  '/event-staffing-atlanta': {
    ...
    subhead: 'Need reliable event staff in Atlanta? V&A Workforce provides vetted workers for events of any size — dispatched by SMS, no group texts.',
    description: [
      ...
      'V&A Workforce specializes in event staffing across the Atlanta metro. Every worker in our pool has been reviewed and approved by our team before they\'re offered shifts. When your event is confirmed, we dispatch each crew member directly by SMS — full details, no group chats, no missed messages.',
      'Whether you need setup and breakdown crew for a stadium event, janitorial support for a multi-day convention, or brand activation staff for a product launch in Atlantic Station, V&A Workforce can staff your crew quickly. Submit your request and we\'ll confirm availability within 24 hours.',
    ],
  },
  '/festival-staff-atlanta': {
    keyword: 'festival staff Atlanta',
    headline: 'Festival Staff in Atlanta — Ready When You Are',
    subhead: 'From Music Midtown to local neighborhood festivals, V&A Workforce provides experienced festival staff across the Atlanta area.',
    description: [
      ...
      'V&A Workforce provides festival staff across Atlanta and the surrounding metro area. Our workers are vetted, briefed before every event, and dispatched individually by SMS so there\'s no confusion about where to go or who to report to. We staff janitorial crews, setup and breakdown teams, registration and check-in staff, security support, and general labor.',
      'Festivals move fast. V&A Workforce moves faster. Submit your festival staffing request and we\'ll build your crew roster and confirm availability within 24 hours. Our on-site supervisor support means you\'ll always have a point of contact for the day of.',
    ],
  },
  '/event-labor-atlanta': {
  ...
  '/crowd-control-staffing-atlanta': {
    ...
    description: [
      ...
      'V&A Workforce provides crowd control staffing support across the Atlanta area. Our workers are reviewed before approval, briefed on event-specific protocols before their shift, and dispatched directly with SMS instructions covering their assignment, meeting point, supervisor contact, and dress code.',
  ...
  '/brand-activation-staff-atlanta': {
    ...
    description: [
      ...
      'V&A Workforce staffs brand activation roles across Atlanta and the surrounding metro area. We provide staff for product demonstrations, sampling, registration, check-in, social media activation support, and general event labor. All workers are pre-approved, vetted by our team, and briefed with your brand guidelines and shift details before they arrive.',
      'From Midtown to Buckhead to East Atlanta, V&A Workforce can build a crew for your next activation quickly. We dispatch each team member individually by SMS — no group chats, no last-minute dropouts going unnoticed. Submit your activation staffing request and we\'ll confirm your team within 24 hours.',
    ],
  },
  ...
  '/trade-show-staffing-atlanta': {
    ...
    description: [
      ...
      'V&A Workforce provides trade show staffing across Atlanta convention venues. Every worker is vetted before joining our pool and receives an individual SMS briefing before their shift — meeting point, supervisor contact, dress code, and role-specific instructions. No group chats. No missed messages. Just workers who show up prepared.',
      'Whether you need a 6-person load-in crew for a booth installation or 20 registration staff for a multi-day conference, V&A Workforce can build your roster and confirm within 24 hours. Submit your trade show staffing request and we\'ll get back to you the same day.',
    ],
  },
  '/conference-staffing-atlanta': {
    ...
    description: [
      ...
      'V&A Workforce staffs Atlanta conferences with vetted, briefed workers across every role in your event. Registration and check-in staff, room monitors, break service support, load-in crews, and general event labor — all dispatched individually by SMS with shift-specific briefing details before they arrive on site.',
      'Corporate conferences have tight timelines and high visibility. A registration line that backs up at 8am sets the wrong tone for the entire day. V&A Workforce\'s pre-briefing system means your staff knows exactly where to go, who to report to, and what the plan is before they walk through the door. Submit your conference staffing request and we\'ll confirm your crew within 24 hours.',
    ],
  },
  '/corporate-event-staffing-atlanta': {
    ...
    description: [
      ...
      'V&A Workforce provides corporate event staffing across Atlanta. We staff setup and breakdown crews, catering servers and runners, registration and check-in staff, and general event labor. Every worker in our pool is vetted and pre-approved. Every worker receives an individual SMS briefing 24 hours before their shift covering their meeting point, supervisor contact, dress code, and role.',
      'Whether you\'re staffing a 50-person client dinner in Buckhead or a 500-person gala at a downtown Atlanta venue, V&A Workforce can build your crew and confirm availability within 24 hours. Submit a corporate event staffing request and we\'ll get back to you the same day.',
    ],
  },
  '/event-setup-crew-atlanta': {
    ...
    description: [
      ...
      'V&A Workforce provides event setup crews across Atlanta. Our workers are vetted, briefed before every shift, and dispatched individually by SMS with their meeting point, supervisor contact, and setup-specific instructions. Whether you need a 3-person furniture setup crew for a ballroom flip or a 10-person load-in team for a major installation, we can staff your crew quickly.',
      'Atlanta venues have specific load-in windows, dock access requirements, and equipment protocols. V&A Workforce\'s briefing system includes venue-specific details so your setup crew isn\'t learning the building on your time. Submit your setup crew request and we\'ll confirm within 24 hours.',
    ],
  },
  ...
  '/catering-staff-atlanta': {
    ...
    description: [
      ...
      'V&A Workforce provides catering support staff for Atlanta events across every service format: plated dinners, buffet service, cocktail receptions, and banquet events. All workers are vetted, pre-approved, and briefed before their shift with specific service instructions, floor layouts, and supervisor contacts.',
      'Catering staff ratios matter. For plated service, plan for 1 server per 10–12 guests. For buffet, 1 per 20–25. V&A Workforce can help you calculate the right headcount for your event format and confirm your team within 24 hours of your request.',
    ],
  },
  ...
  '/wedding-event-staff-atlanta': {
    ...
    description: [
      ...
      'Atlanta wedding venues each have their own access protocols, vendor timelines, and load-in requirements. V&A Workforce\'s briefing process includes venue-specific information so your crew arrives knowing the plan. Submit your wedding staffing request and we\'ll confirm your team within 24 hours.',
    ],
  },
  ...
  '/event-staffing-midtown-atlanta': {
    ...
    description: [
      ...
      'V&A Workforce staffs Midtown Atlanta events with vetted, briefed workers across every role. Whether you\'re managing a 2,000-person outdoor event in Piedmont Park or a 150-person conference at a Midtown hotel, we can build your crew roster and confirm availability within 24 hours.',
  ...
  '/event-staffing-decatur-ga': {
    ...
    description: [
      ...
      'V&A Workforce provides event staffing for Decatur events, including setup crews, festival staff, registration workers, janitorial teams, and general event labor. All workers are vetted, pre-approved, and briefed individually by SMS before their shift.',
  ...
  '/event-staffing-sandy-springs-ga': {
    ...
    description: [
      ...
      'V&A Workforce provides event staffing for Sandy Springs events. Our workers are vetted, briefed before every shift, and dispatched directly by SMS with venue-specific instructions. We staff setup and breakdown crews, catering support, registration staff, and general event labor.',
  ...
  '/event-staffing-marietta-ga': {
    ...
    description: [
      ...
      'V&A Workforce provides event staffing for Marietta and the Cobb County area. Every worker is vetted before joining our pool and briefed individually by SMS before their shift with specific meeting points, supervisor contacts, and role details.',
  ...
  '/event-staffing-alpharetta-ga': {
    ...
    description: [
      ...
      'V&A Workforce provides event staffing for Alpharetta and the North Fulton area. We staff setup crews, catering support, registration staff, janitorial teams, and general event labor. All workers are pre-approved and briefed by SMS before their shift.',
  ...
  '/event-staffing-college-park-ga': {
    ...
    description: [
      ...
      'V&A Workforce provides event staffing for College Park venues. Our workers are vetted, briefed before every shift, and dispatched individually by SMS. We staff conference registration crews, catering support, setup and breakdown teams, and general event labor.',
  ...
  '/event-staff-georgia-world-congress-center': {
    ...
    description: [
      ...
      'V&A Workforce provides event staffing for GWCC events. We staff load-in and breakdown crews, trade show booth labor, registration and check-in staff, floor support, and janitorial teams. Every worker is vetted before joining our pool and briefed individually by SMS with GWCC-specific meeting points, dock access details, and supervisor contacts.',
  ...
  '/event-staff-ponce-city-market': {
    ...
    description: [
      ...
      'V&A Workforce provides event staff for Ponce City Market events. We staff brand activation teams, setup crews, catering support, registration workers, and general event labor. All workers are briefed with PCM-specific meeting points and access details before their shift.',
  ...
  '/event-staff-mercedes-benz-stadium': {
    ...
    description: [
      ...
      'V&A Workforce provides event staff for Mercedes-Benz Stadium area events. We staff large-scale setup and breakdown crews, janitorial and cleanup teams, load-in labor, registration and check-in staff, and general event support. Every worker is vetted, pre-approved, and briefed individually by SMS before their shift.',
