    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white flex flex-col">
      ...
      <div className="px-6 py-16 max-w-4xl mx-auto w-full">
        ...
        <button
          ...
          className="bg-[#16a34a] text-black rounded-full py-4 px-10 font-semibold text-base hover:opacity-90 transition-all duration-200 fade-up-delay-2"
        >
          Request Staff →
        </button>
      ...
      <div className="px-6 py-16 border-t border-[#1a1a1a] max-w-4xl mx-auto w-full">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="border border-[#16a34a]/30 bg-[#16a34a]/[0.02] rounded-xl p-5">
