...
export function getAgreementHtml({ deposit, balance, total } = {}) {
  ...
  return `
    <div style="background:#141414;border:1px solid #1e1e1e;border-radius:8px;padding:24px;margin:20px 0;font-size:13px;color:#ccc;line-height:1.7">
      <h3 style="margin:0 0 12px;font-size:16px;color:#16a34a;border-bottom:2px solid #ffffff;padding-bottom:8px">V&A Hire Staffing Services Agreement</h3>
      ...
      <p style="margin:16px 0 6px;font-weight:bold;color:#16a34a">1. Scope of Services</p>
      ...
      <p style="margin:16px 0 6px;font-weight:bold;color:#16a34a">2. Payment Terms</p>
      ...
      <p style="margin:16px 0 6px;font-weight:bold;color:#16a34a">3. Card Authorization & Future Charges</p>
      <p style="margin:0 0 10px">By providing payment information and accepting this Agreement, Client authorizes V&A Hire to: (a) charge the deposit amount immediately; (b) store the payment method securely for future charges; (c) automatically charge the balance amount on or after the Net 15 due date; (d) charge any applicable late fees, penalties, or additional charges incurred under this Agreement. This authorization remains in effect until all obligations under this Agreement are fulfilled.</p>

      <p style="margin:16px 0 6px;font-weight:bold;color:#16a34a">4. Non-Dispute & Chargeback Policy</p>
      ...
      <p style="margin:16px 0 6px;font-weight:bold;color:#16a34a">5. Cancellation & Refund Policy</p>
      ...
      <p style="margin:16px 0 6px;font-weight:bold;color:#16a34a">11. Governing Law & Jurisdiction</p>
      ...
      <p style="margin:16px 0 6px;font-weight:bold;color:#16a34a">12. Prevailing Party Attorney's Fees</p>
      ...
      <p style="margin:16px 0 6px;font-weight:bold;color:#16a34a">13. Force Majeure</p>
      ...
      <p style="margin:16px 0 6px;font-weight:bold;color:#16a34a">14. Entire Agreement</p>
